...
export default function LoginPage() {
  ...
  const demoLogins = [
    { role: 'Candidate', email: 'john@example.com', password: 'password' },
    { role: 'Employer', email: 'alice@techcorp.com', password: 'password' },
    { role: 'Admin', email: 'admin@jobboard.com', password: 'password' }
  ];
