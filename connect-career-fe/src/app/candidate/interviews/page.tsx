...
import { Calendar, MessageSquare, Eye, Heart } from 'lucide-react';
...
export default function CandidateInterviewsPage() {
  ...
  const candidateInterviews = mockInterviews.filter(interview => interview.candidateId === 'cand1'); // Mock current user
