...
const cvTemplates = [
  { id: 'modern', name: 'Modern Professional', color: '#2563eb', desc: 'Clean and contemporary design' },
  { id: 'executive', name: 'Executive', color: '#1e293b', desc: 'Traditional corporate style' },
  { id: 'creative', name: 'Creative Designer', color: '#7c3aed', desc: 'Bold and unique layout' },
  { id: 'minimal', name: 'Minimal Clean', color: '#000000', desc: 'Simple and elegant' },
  { id: 'sidebar', name: 'Sidebar Layout', color: '#0891b2', desc: 'Two-column asymmetric' },
  { id: 'timeline', name: 'Timeline', color: '#059669', desc: 'Visual chronological' },
  { id: 'compact', name: 'Compact Dense', color: '#6b7280', desc: 'Maximum information' },
  { id: 'academic', name: 'Academic', color: '#92400e', desc: 'Formal research style' },
  { id: 'technical', name: 'Technical', color: '#dc2626', desc: 'Developer focused' },
  { id: 'elegant', name: 'Elegant Classic', color: '#d97706', desc: 'Sophisticated traditional' }
];
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl p-8 max-w-md mx-4 shadow-2xl">
        ...
        <h3 className="text-2xl font-bold text-center text-gray-900 mb-3">Cancel CV Improvement?</h3>
        <p className="text-gray-600 text-center mb-8">All your progress will be lost. Are you sure you want to cancel?</p>
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p className="text-lg text-gray-600">AI-powered enhancement in minutes</p>
          </div>
          <button
            onClick={onCancel}
            className="px-5 py-2.5 bg-white text-gray-700 rounded-xl hover:shadow-md border border-gray-200 transition-all font-medium"
          >
            Cancel
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div
            ...
            className={`bg-white rounded-3xl p-8 cursor-pointer transition-all ${
              selectedOption === 'upload' ? 'ring-2 ring-blue-500 shadow-2xl scale-105' : 'hover:shadow-xl'
            }`}
          >
            <div className="text-center">
              <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-5 transition-all ${
                selectedOption === 'upload' ? 'bg-blue-600' : 'bg-blue-100'
              }`}>
                <svg className={`w-10 h-10 ${selectedOption === 'upload' ? 'text-white' : 'text-blue-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Upload New CV</h3>
              <p className="text-gray-600 mb-6">Upload PDF, DOC, or DOCX file</p>
              ...
              {selectedOption === 'upload' && (
                <div>
                  ...
                  <label
                    htmlFor="cv-upload"
                    className="inline-block px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 cursor-pointer transition-colors font-medium"
                  >
                    Choose File
                  </label>
                  {uploadedFile && (
          ...
          <div
            ...
            className={`bg-white rounded-3xl p-8 cursor-pointer transition-all ${
              selectedOption === 'existing' ? 'ring-2 ring-green-500 shadow-2xl scale-105' : 'hover:shadow-xl'
            }`}
          >
            <div className="text-center">
              <div className={`w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-5 transition-all ${
                selectedOption === 'existing' ? 'bg-green-600' : 'bg-green-100'
              }`}>
                <svg className={`w-10 h-10 ${selectedOption === 'existing' ? 'text-white' : 'text-green-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Select Existing CV</h3>
              <p className="text-gray-600 mb-6">Choose from your library</p>
                ...
                <div className="space-y-3">
                  {mockExistingCVs.map(cv => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-500">{cv.date}</p>
                    </div>
                  ))}
                </div>
              )}
        ...
        {((selectedOption === 'upload' && uploadedFile) || (selectedOption === 'existing' && selectedCV)) && (
          <div className="text-center">
            <button
              ...
              className="px-10 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:shadow-xl disabled:opacity-50 transition-all font-semibold text-lg"
            >
...
const JobDescriptionStep = ({ onNext, onBack, onCancel }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-600">Optional but recommended for tailored improvements</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl">
          ...
          <textarea
            ...
            placeholder="Paste the job description here to get personalized CV improvements tailored to the role..."
            className="w-full h-72 p-4 border-2 border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all"
          />
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:shadow-xl disabled:opacity-50 transition-all font-semibold"
            >
...
const SuggestionCard = ({ suggestion, onApprove, onDismiss }) => {
  return (
    <div className="bg-white p-5 rounded-2xl border-2 border-gray-100 hover:border-blue-200 transition-all">
      <p className="text-sm text-gray-600 mb-3 font-medium">{suggestion.reason}</p>
      <div className="text-sm bg-gray-50 p-4 rounded-xl mb-4 font-mono">
        {suggestion.diff.map((segment, index) => (
          <span
            key={index}
            className={
              segment.type === 'deletion'
                ? 'bg-red-100 text-red-700 line-through px-1 rounded'
                : segment.type === 'suggestion'
                ? 'bg-green-100 text-green-700 font-medium px-1 rounded'
                : 'text-gray-700'
            }
          >
            {segment.value}
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 px-4 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition-colors text-sm font-medium text-gray-700"
        >
          Dismiss
        </button>
        <button
          onClick={() => onApprove(suggestion)}
          className="flex-1 px-4 py-2 rounded-xl bg-green-600 hover:bg-green-700 transition-colors text-white text-sm font-medium"
        >
          Apply
        </button>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:shadow-lg transition-all font-semibold"
            >
              Choose Template →
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-white">
          <div className="max-w-3xl mx-auto">
            <div className="text-center pb-8 border-b mb-8">
              <h2 className="text-4xl font-bold text-gray-900">{cvData.personalInfo.name}</h2>
              <p className="text-xl text-blue-600 mt-2">{cvData.personalInfo.title}</p>
              <div className="text-sm text-gray-600 mt-3 space-x-2">
            ...
            {cvData.skills?.length > 0 && (
              <section className="mb-8">
                <h3 className="text-2xl font-bold text-gray-800 mb-4 pb-2 border-b-2 border-blue-600">Skills</h3>
            ...
            {cvData.projects?.length > 0 && (
              <section className="mb-8">
                <h3 className="text-2xl font-bold text-gray-800 mb-4 pb-2 border-b-2 border-blue-600">Projects</h3>
        ...
        <div className="w-96 bg-gray-50 border-l overflow-y-auto p-6">
          ...
          {totalSuggestions === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="font-medium text-gray-800">All suggestions applied!</p>
              <p className="text-sm text-gray-600 mt-2">Ready to choose a template</p>
            </div>
          ) : (
...
// ============================================================================
// CV TEMPLATE RENDERERS - DIVERSE DESIGNS
// ============================================================================

const ModernTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
    ...
    <div className={`p-8 bg-white ${font}`} style={{ minHeight: '297mm' }}>
      {sectionVisibility.personalInfo && (
        <header className="text-center mb-8 pb-6 border-b-2" style={{ borderColor: color }}>
          <h1 className="text-5xl font-bold mb-2" style={{ color }}>{personalInfo.name}</h1>
      ...
      {sectionVisibility.skills && skills.length > 0 && (
        <section className="mb-6">
          <h2 className="text-2xl font-bold mb-3 pb-2 border-b-2" style={{ color, borderColor: color }}>Skills</h2>
          <div className="flex flex-wrap gap-2">
            {skills.map((skill, idx) => (
              <span key={idx} className="px-3 py-1 rounded-full text-sm font-medium" style={{ backgroundColor: `${color}20`, color }}>
                {skill}
              </span>
            ))}
          </div>
      ...
      {sectionVisibility.workExperience && workExperience.length > 0 && (
        <section className="mb-6">
          <h2 className="text-2xl font-bold mb-3 pb-2 border-b-2" style={{ color, borderColor: color }}>Work Experience</h2>
          {workExperience.map(work => (
            <div key={work.id} className="mb-4">
              <h3 className="text-lg font-semibold">{work.position}</h3>
              <p className="text-md font-medium" style={{ color }}>{work.company}</p>
      ...
      {sectionVisibility.projects && projects.length > 0 && (
        <section className="mb-6">
          <h2 className="text-2xl font-bold mb-3 pb-2 border-b-2" style={{ color, borderColor: color }}>Projects</h2>
      ...
      {sectionVisibility.education && education.length > 0 && (
        <section className="mb-6">
          <h2 className="text-2xl font-bold mb-3 pb-2 border-b-2" style={{ color, borderColor: color }}>Education</h2>
          {education.map(edu => (
      ...
      {sectionVisibility.awards && awards.length > 0 && (
        <section className="mb-6">
          <h2 className="text-2xl font-bold mb-3 pb-2 border-b-2" style={{ color, borderColor: color }}>Awards</h2>
          {awards.map(award => (
...
const SidebarTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  ...
  return (
    <div className={`flex ${font}`} style={{ minHeight: '297mm' }}>
      <div className="w-1/3 p-6 text-white" style={{ backgroundColor: color }}>
        ...
        {sectionVisibility.skills && skills.length > 0 && (
          <div className="mb-6">
            <h2 className="text-xl font-bold mb-3 pb-2 border-b border-white border-opacity-30">Skills</h2>
            <div className="space-y-2">
              {skills.map((skill, idx) => (
                <div key={idx} className="text-sm py-1">{skill}</div>
              ))}
            </div>
          </div>
        )}
        ...
        {sectionVisibility.education && education.length > 0 && (
          <div className="mb-6">
            <h2 className="text-xl font-bold mb-3 pb-2 border-b border-white border-opacity-30">Education</h2>
            {education.map(edu => (
      ...
      <div className="w-2/3 p-8 bg-white">
        {sectionVisibility.workExperience && workExperience.length > 0 && (
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-4 pb-2 border-b-2" style={{ color, borderColor: color }}>Work Experience</h2>
            {workExperience.map(work => (
        ...
        {sectionVisibility.projects && projects.length > 0 && (
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-4 pb-2 border-b-2" style={{ color, borderColor: color }}>Projects</h2>
            {projects.map(project => (
        ...
        {sectionVisibility.awards && awards.length > 0 && (
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-4 pb-2 border-b-2" style={{ color, borderColor: color }}>Awards</h2>
            {awards.map(award => (
...
const MinimalTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
    ...
    <div className={`p-12 bg-white ${font}`} style={{ minHeight: '297mm' }}>
      {sectionVisibility.personalInfo && (
        <header className="mb-8">
          <h1 className="text-6xl font-light mb-1" style={{ color }}>{personalInfo.name}</h1>
      ...
      {sectionVisibility.workExperience && workExperience.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color }}>Experience</h2>
          {workExperience.map(work => (
            <div key={work.id} className="mb-5">
              <div className="flex justify-between items-baseline mb-1">
                <h3 className="text-lg font-semibold">{work.position}</h3>
                <span className="text-sm text-gray-500">{work.startDate} - {work.endDate}</span>
              </div>
      ...
      {sectionVisibility.projects && projects.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color }}>Projects</h2>
          {projects.map(project => (
            <div key={project.id} className="mb-5">
              <div className="flex justify-between items-baseline mb-1">
                <h3 className="text-lg font-semibold">{project.title}</h3>
      ...
      {sectionVisibility.education && education.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color }}>Education</h2>
          {education.map(edu => (
            <div key={edu.id} className="mb-3">
      ...
      {sectionVisibility.skills && skills.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color }}>Skills</h2>
      ...
      {sectionVisibility.awards && awards.length > 0 && (
        <section className="mb-8">
          <h2 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color }}>Awards</h2>
          {awards.map(award => (
            <div key={award.id} className="mb-2">
              <span className="font-semibold">{award.title}</span>
...
const ExecutiveTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  
  return (
    <div className={`p-8 bg-white ${font}`} style={{ minHeight: '297mm' }}>
      {sectionVisibility.personalInfo && (
        <header className="text-center mb-6 pb-4 border-b-4 border-gray-800">
          <h1 className="text-4xl font-bold mb-1 tracking-wide uppercase" style={{ color }}>{personalInfo.name}</h1>
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2">
          {sectionVisibility.workExperience && workExperience.length > 0 && (
            <section className="mb-6">
              <h2 className="text-xl font-bold uppercase tracking-wide mb-3 pb-1 border-b-2 border-gray-300">Professional Experience</h2>
              {workExperience.map(work => (
                <div key={work.id} className="mb-4">
                  <h3 className="text-md font-bold">{work.position}</h3>
                  <p className="text-sm font-semibold text-gray-700">{work.company} | {work.startDate} - {work.endDate}</p>
          ...
          {sectionVisibility.projects && projects.length > 0 && (
            <section className="mb-6">
              <h2 className="text-xl font-bold uppercase tracking-wide mb-3 pb-1 border-b-2 border-gray-300">Key Projects</h2>
              {projects.map(project => (
                <div key={project.id} className="mb-4">
        ...
        <div>
          {sectionVisibility.education && education.length > 0 && (
            <section className="mb-6">
              <h2 className="text-lg font-bold uppercase tracking-wide mb-3 pb-1 border-b-2 border-gray-300">Education</h2>
              {education.map(edu => (
                <div key={edu.id} className="mb-3 text-sm">
          ...
          {sectionVisibility.skills && skills.length > 0 && (
            <section className="mb-6">
              <h2 className="text-lg font-bold uppercase tracking-wide mb-3 pb-1 border-b-2 border-gray-300">Core Skills</h2>
          ...
          {sectionVisibility.awards && awards.length > 0 && (
            <section className="mb-6">
              <h2 className="text-lg font-bold uppercase tracking-wide mb-3 pb-1 border-b-2 border-gray-300">Honors</h2>
              {awards.map(award => (
...
const CreativeTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  ...
  return (
    <div className={`${font}`} style={{ minHeight: '297mm' }}>
      ...
      <div className="p-8 bg-white">
        {sectionVisibility.skills && skills.length > 0 && (
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-4" style={{ color }}>Skills & Expertise</h2>
            <div className="grid grid-cols-3 gap-2">
              {skills.map((skill, idx) => (
                <div key={idx} className="p-2 border-l-4 text-sm font-medium" style={{ borderColor: color }}>
                  {skill}
                </div>
              ))}
            </div>
        ...
        {sectionVisibility.workExperience && workExperience.length > 0 && (
          <section className="mb-6">
            ...
            {workExperience.map(work => (
              <div key={work.id} className="mb-5 border-l-4 pl-4" style={{ borderColor: color }}>
                <h3 className="text-xl font-bold">{work.position}</h3>
                <p className="text-lg font-semibold text-gray-700">{work.company}</p>
                <p className="text-sm text-gray-500 mb-2">{work.startDate} - {work.endDate}</p>
                <ul className="list-none text-gray-700 space-y-1">
                  {work.responsibilities.map((resp, idx) => (
                    <li key={idx} className="before:content-['▸'] before:mr-2" style={{ color }}>{resp}</li>
                  ))}
                </ul>
              </div>
            ))}
        ...
        {sectionVisibility.projects && projects.length > 0 && (
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-4" style={{ color }}>Featured Projects</h2>
            <div className="grid gap-4">
              {projects.map(project => (
                <div key={project.id} className="p-4 border-2 rounded-lg" style={{ borderColor: `${color}40` }}>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          {sectionVisibility.awards && awards.length > 0 && (
            <section className="mb-6">
              <h2 className="text-2xl font-bold mb-4" style={{ color }}>Awards & Recognition</h2>
              {awards.map(award => (
                <div key={award.id} className="mb-3">
...
const TimelineTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  ...
  return (
    <div className={`p-8 bg-white ${font}`} style={{ minHeight: '297mm' }}>
      ...
      {sectionVisibility.skills && skills.length > 0 && (
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-3" style={{ color }}>Skills</h2>
          <div className="flex flex-wrap gap-2">
            {skills.map((skill, idx) => (
              <span key={idx} className="px-3 py-1 bg-gray-100 text-gray-800 rounded text-sm font-medium">
                {skill}
              </span>
            ))}
          </div>
      ...
      {sectionVisibility.workExperience && workExperience.length > 0 && (
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4" style={{ color }}>Career Timeline</h2>
          <div className="border-l-4 pl-6 space-y-6" style={{ borderColor: color }}>
            {workExperience.map((work, idx) => (
              <div key={work.id} className="relative">
                <div className="absolute -left-9 w-5 h-5 rounded-full border-4 bg-white" style={{ borderColor: color }}></div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-lg font-bold">{work.position}</h3>
                  <p className="text-md font-semibold" style={{ color }}>{work.company}</p>
                  <p className="text-sm text-gray-500 mb-2">{work.startDate} - {work.endDate}</p>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    {work.responsibilities.map((resp, idx) => (
                      <li key={idx}>{resp}</li>
      ...
      {sectionVisibility.projects && projects.length > 0 && (
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4" style={{ color }}>Projects Timeline</h2>
          <div className="border-l-4 pl-6 space-y-6" style={{ borderColor: color }}>
            {projects.map(project => (
      ...
      <div className="grid grid-cols-2 gap-6">
        {sectionVisibility.education && education.length > 0 && (
          <section className="mb-6">
            <h2 className="text-xl font-bold mb-3" style={{ color }}>Education</h2>
            {education.map(edu => (
        ...
        {sectionVisibility.awards && awards.length > 0 && (
          <section className="mb-6">
            <h2 className="text-xl font-bold mb-3" style={{ color }}>Awards</h2>
            {awards.map(award => (
...
const CompactTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  
  return (
    <div className={`p-6 bg-white ${font} text-sm`} style={{ minHeight: '297mm' }}>
      {sectionVisibility.personalInfo && (
        <header className="mb-4 pb-3 border-b-2" style={{ borderColor: color }}>
          <h1 className="text-3xl font-bold" style={{ color }}>{personalInfo.name}</h1>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div>
          {sectionVisibility.skills && skills.length > 0 && (
            <section className="mb-4">
              <h2 className="text-lg font-bold mb-2" style={{ color }}>Skills</h2>
              <div className="space-y-1">
                {skills.map((skill, idx) => (
          ...
          {sectionVisibility.education && education.length > 0 && (
            <section className="mb-4">
              <h2 className="text-lg font-bold mb-2" style={{ color }}>Education</h2>
              {education.map(edu => (
        ...
        <div className="col-span-3">
          {sectionVisibility.workExperience && workExperience.length > 0 && (
            <section className="mb-4">
              <h2 className="text-lg font-bold mb-2" style={{ color }}>Experience</h2>
              {workExperience.map(work => (
                <div key={work.id} className="mb-3">
                  ...
                  <p className="text-xs font-semibold text-gray-700">{work.company}</p>
          ...
          {sectionVisibility.projects && projects.length > 0 && (
            <section className="mb-4">
              <h2 className="text-lg font-bold mb-2" style={{ color }}>Projects</h2>
              {projects.map(project => (
          ...
          {sectionVisibility.awards && awards.length > 0 && (
            <section className="mb-4">
              <h2 className="text-lg font-bold mb-2" style={{ color }}>Awards</h2>
              <div className="space-y-1">
                {awards.map(award => (
                  <div key={award.id}>
...
const AcademicTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  ...
  return (
    <div className={`p-10 bg-white ${font}`} style={{ minHeight: '297mm' }}>
          ...
          {workExperience.map(work => (
            <div key={work.id} className="mb-4">
              <div className="flex justify-between mb-1">
                <h3 className="text-lg font-semibold">{work.position}</h3>
                <span className="text-sm text-gray-600">{work.startDate} - {work.endDate}</span>
              </div>
              <p className="text-md text-gray-700 italic mb-2">{work.company}</p>
              <ul className="list-disc list-inside text-gray-700 space-y-1">
                {work.responsibilities.map((resp, idx) => (
                  <li key={idx}>{resp}</li>
                ))}
      ...
      {sectionVisibility.projects && projects.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-3 uppercase">Research & Projects</h2>
          {projects.map(project => (
            <div key={project.id} className="mb-4">
              <div className="flex justify-between mb-1">
                <h3 className="text-lg font-semibold">{project.title}</h3>
      ...
      {sectionVisibility.skills && skills.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-3 uppercase">Skills & Competencies</h2>
          <p className="text-gray-700">{skills.join(', ')}</p>
        </section>
      )}
      ...
      {sectionVisibility.awards && awards.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold mb-3 uppercase">Honors & Awards</h2>
          {awards.map(award => (
            <div key={award.id} className="mb-2">
              <p className="font-semibold">{award.title} <span className="text-gray-600 font-normal">({award.date})</span></p>
              <p className="text-gray-700 text-sm">{award.description}</p>
            </div>
          ))}
        </section>
...
const TechnicalTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
  
  return (
    <div className={`p-8 bg-gray-50 ${font}`} style={{ minHeight: '297mm' }}>
      {sectionVisibility.personalInfo && (
        <header className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <h1 className="text-4xl font-bold mb-2" style={{ color }}>{personalInfo.name}</h1>
          <p className="text-xl text-gray-700 mb-3">{personalInfo.title}</p>
      ...
      {sectionVisibility.skills && skills.length > 0 && (
        <section className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <h2 className="text-2xl font-bold mb-4 font-mono" style={{ color }}>// Technical Skills</h2>
          <div className="grid grid-cols-4 gap-2">
            {skills.map((skill, idx) => (
              <div key={idx} className="px-3 py-2 bg-gray-100 rounded font-mono text-xs border-l-2" style={{ borderColor: color }}>
                {skill}
              </div>
            ))}
          </div>
      ...
      {sectionVisibility.projects && projects.length > 0 && (
        <section className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <h2 className="text-2xl font-bold mb-4 font-mono" style={{ color }}>// Projects</h2>
          {projects.map(project => (
            <div key={project.id} className="mb-5 pb-5 border-b border-gray-200 last:border-0">
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-lg font-bold font-mono">{project.title}</h3>
                <span className="text-sm text-gray-500 font-mono">{project.startDate} - {project.endDate}</span>
              </div>
              <p className="text-gray-700 mb-3">{project.description}</p>
              {project.techStack && project.techStack.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-3">
                  {project.techStack.map((tech, idx) => (
                    <span key={idx} className="px-2 py-1 bg-gray-800 text-white text-xs rounded font-mono">
                      {tech}
                    </span>
                  ))}
                </div>
                ...
                <ul className="space-y-1">
                  {project.responsibilities.map((resp, idx) => (
                    <li key={idx} className="text-sm text-gray-700">
                      <span className="font-mono mr-2" style={{ color }}>›</span>{resp}
                    </li>
                  ))}
                </ul>
              )}
      ...
      {sectionVisibility.workExperience && workExperience.length > 0 && (
        <section className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <h2 className="text-2xl font-bold mb-4 font-mono" style={{ color }}>// Work Experience</h2>
          {workExperience.map(work => (
            <div key={work.id} className="mb-5 pb-5 border-b border-gray-200 last:border-0">
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h3 className="text-lg font-bold">{work.position}</h3>
                  <p className="text-md font-semibold text-gray-700">{work.company}</p>
                </div>
                <span className="text-sm text-gray-500 font-mono">{work.startDate} - {work.endDate}</span>
              </div>
              <ul className="space-y-1">
                {work.responsibilities.map((resp, idx) => (
                  <li key={idx} className="text-sm text-gray-700">
      ...
      <div className="grid grid-cols-2 gap-6">
        {sectionVisibility.education && education.length > 0 && (
          <section className="bg-white p-6 rounded-lg shadow-sm">
            <h2 className="text-xl font-bold mb-3 font-mono" style={{ color }}>// Education</h2>
            {education.map(edu => (
              <div key={edu.id} className="mb-3">
                <h3 className="font-bold">{edu.degree}</h3>
                <p className="text-sm text-gray-700">{edu.institution}</p>
                <p className="text-xs text-gray-500 font-mono">{edu.startDate} - {edu.endDate}</p>
                <p className="text-xs text-gray-600 font-mono">GPA: {edu.gpa}</p>
              </div>
            ))}
          </section>
        )}
        ...
        {sectionVisibility.awards && awards.length > 0 && (
          <section className="bg-white p-6 rounded-lg shadow-sm">
            <h2 className="text-xl font-bold mb-3 font-mono" style={{ color }}>// Awards</h2>
            {awards.map(award => (
              <div key={award.id} className="mb-3">
                <p className="font-bold text-sm">{award.title}</p>
...
const ElegantTemplate = ({ cvData, color, font }) => {
  const { personalInfo, skills, workExperience, education, projects, awards, sectionVisibility } = cvData;
    ...
    <div className={`p-10 bg-white ${font}`} style={{ minHeight: '297mm' }}>
      {sectionVisibility.personalInfo && (
        <header className="text-center mb-8">
          <h1 className="text-5xl font-serif mb-3" style={{ color }}>{personalInfo.name}</h1>
          <div className="w-24 h-1 mx-auto mb-4" style={{ backgroundColor: color }}></div>
          <p className="text-xl text-gray-700 mb-3 italic">{personalInfo.title}</p>
          <div className="text-sm text-gray-600">
            {personalInfo.email} · {personalInfo.phone} · {personalInfo.address}
          </div>
        </header>
      ...
      {sectionVisibility.workExperience && workExperience.length > 0 && (
        <section className="mb-8">
          <div className="text-center mb-4">
            <h2 className="text-2xl font-serif inline-block px-6 py-2" style={{ color, borderBottom: `2px solid ${color}` }}>
          ...
          {workExperience.map(work => (
            <div key={work.id} className="mb-5">
              <div className="flex justify-between items-baseline mb-1">
                <h3 className="text-lg font-semibold">{work.position}</h3>
                <span className="text-sm text-gray-500 italic">{work.startDate} - {work.endDate}</span>
              </div>
              <p className="text-md text-gray-700 mb-2 italic">{work.company}</p>
              <ul className="list-none text-gray-700 space-y-1 pl-4">
                {work.responsibilities.map((resp, idx) => (
                  <li key={idx} className="relative before:content-['◆'] before:absolute before:-left-4 before:text-xs" style={{ color }}>
                    {resp}
                  </li>
                ))}
              </ul>
        ...
        <section className="mb-8">
          ...
          {projects.map(project => (
            <div key={project.id} className="mb-5">
              <div className="flex justify-between items-baseline mb-1">
                <h3 className="text-lg font-semibold">{project.title}</h3>
                <span className="text-sm text-gray-500 italic">{project.startDate} - {project.endDate}</span>
              </div>
              <p className="text-gray-700 mb-2">{project.description}</p>
              {project.responsibilities && project.responsibilities.length > 0 && (
                <ul className="list-none text-gray-700 space-y-1 pl-4">
        ...
        {sectionVisibility.education && education.length > 0 && (
          <section className="mb-6">
            <div className="text-center mb-3">
              <h2 className="text-xl font-serif inline-block px-4 py-1" style={{ color, borderBottom: `2px solid ${color}` }}>
                Education
              </h2>
            </div>
            {education.map(edu => (
...
const CVTemplateRenderer = ({ cvData, templateId, primaryColor, fontFamily }) => {
  const templates = {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-600">Select a professional template that best represents your style</p>
        </div>
...
const EditTemplateStep = ({ cvData: initialData, templateId, onBack, onCancel }) => {
  const [cvData, setCvData] = useState(initialData);
  ...
  const addItem = (section) => {
    const newItems = {
      workExperience: { id: Date.now().toString(), company: '', position: '', startDate: '', endDate: '', responsibilities: [''] },
      education: { id: Date.now().toString(), institution: '', degree: '', startDate: '', endDate: '', gpa: '' },
      projects: { id: Date.now().toString(), title: '', description: '', startDate: '', endDate: '', responsibilities: [], techStack: [] },
      awards: { id: Date.now().toString(), title: '', date: '', description: '' }
    };
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            {showCustomization && (
              <section className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-6">
                      ...
                      {colorPresets.map(color => (
                        <button
                          ...
                          className={`w-10 h-10 rounded-lg border-2 transition-all ${
                            primaryColor === color.value ? 'border-gray-800 scale-110 shadow-lg' : 'border-gray-300'
                          }`}
                ...
                <div className="mt-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2">Section Order & Visibility</label>
                  <div className="space-y-2">
                    {cvData.sectionOrder.map((section, index) => (
                      <div
                        key={section}
                        className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-300 hover:border-blue-400 transition-all"
                      >
                        <div className="flex items-center gap-3">
                          <div className="flex flex-col gap-1">
                            ...
                            <button
                              onClick={() => index < cvData.sectionOrder.length - 1 && moveSection(index, index + 1)}
              ...
              {cvData.sectionVisibility.skills && (
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-gray-200 text-gray-700 rounded-full hover:bg-gray-300 text-sm font-medium"
                  >
                    + Add Skill
                  </button>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  {cvData.sectionVisibility.workExperience && (
                    <button
                      ...
                      className="px-4 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm font-medium"
                    >
                      + Add
                    </button>
                  )}
        ...
        <div className="w-1/2 bg-gray-100 overflow-y-auto p-8 border-l">
    ...
    <div className="min-h-screen">
      ...
      {currentStep === 4 && (
        <TemplateSelectionStep
          cvData={cvData}
          onNext={(templateId) => handleStepComplete(4, templateId)}
          onBack={() => handleBack(3)}
          onCancel={handleCancel}
        />
      )}
