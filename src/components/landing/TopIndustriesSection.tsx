              ...
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-3xl font-bold bg-gradient-to-br ${getGradientColor(i)} bg-clip-text text-transparent`}>
                      {ind.value}
                    </span>
                  </div>
                </div>
                ...
                <div className={`p-3 rounded-xl bg-gradient-to-br ${getGradientColor(i)} opacity-10 group-hover:opacity-20 transition-opacity absolute bottom-6 right-6`}></div>
