  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setParams((p) => ({ ...p, status: value === "all" ? undefined : value, page: 1 }))
            }
          >
          ...
          {/* Has Interviews */}
          <Select
            value={params.hasInterviews === undefined ? "all" : params.hasInterviews ? "yes" : "no"}
            onValueChange={(value) =>
              setParams((p) => ({
                ...p,
          ...
          {/* Has Offers */}
          <Select
            value={params.hasOffers === undefined ? "all" : params.hasOffers ? "yes" : "no"}
            onValueChange={(value) =>
              setParams((p) => ({
                ...p,
